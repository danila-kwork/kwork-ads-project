...
import ru.fifthproject.district.data.firebase.question.model.createQuestionLoading
import ru.fifthproject.district.ui.view.SchoolBoard
import ru.fifthproject.district.R
import ru.fifthproject.district.yandexAds.InterstitialYandexAds
import ru.fifthproject.district.yandexAds.RewardedYandexAds
import ru.fifthproject.district.yandexAds.YandexAdsBanner
...
fun MainScreen(
    ...
    var question by remember { mutableStateOf(createQuestionLoading()) }

    LaunchedEffect(key1 = Unit, block = {
        viewModel.getQuestion(onSuccess = { question = it }, onFailure = { Log.e("onFailure",it) })
    })
                        ...
                        .clickable {
                            ...
                            if (index == 1) {
                                ...
                                if (userAnswer.lowercase() == question.answer.lowercase()) {
                                    userAnswer = ""
                                    question = createQuestionLoading()
                                    viewModel.getQuestion(onSuccess = {
                                        question = it
                                    })
                                    Toast
                                        .makeText(
